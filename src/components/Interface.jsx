...
const AboutSection = (props) => {
    ...
    return (
      <Section mobileTop>
        <h1 className="text-4xl md:text-6xl font-extrabold leading-snug mt-8 md:mt-0">
          Hi, I'm
          <br />
          <span className="bg-white px-1 italic">Michell Goris</span>
        </h1>
        <motion.p
        ...
        >
          I am a third-year Software Engineering student with
          <br />
          ...
          <div className=" mt-8 space-y-4">
            {skills.map((skill, index) => (
              <div className="w-full md:w-64" key={index}>
                <motion.h3
                  className="text-lf md:text-xl font-bold text-gray-800"
                  initial={{
                    opacity: 0,
                  }}
                  variants={{
                ...
                <div className="h-2 w-full bg-gray-200 rounded-full mt-2">
                  <motion.div
                    className="h-full bg-yellow-500 md:bg-yellow-500 rounded-full "
  ...
  const ContactSection = () => {
    const [state, handleSubmit] = useForm("mrgwjglz");
    return (
      <Section>
        <h2 className="text-3xl md:text-5xl font-bold">Contact me</h2>
        <div className="mt-8 p-8 rounded-md bg-white bg-opacity-50 w-96 max-w-full">
        {state.succeeded ? (
              <p className="text-gray-900 text-center"> Thank you for your message!</p>
            ) : (
